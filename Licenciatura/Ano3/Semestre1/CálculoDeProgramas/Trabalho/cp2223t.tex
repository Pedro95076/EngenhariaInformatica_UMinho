...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{f}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{1}\mathrel{=}\mathrm{1}{}\<[E]%
...
\>[B]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{2}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{a}\mathbin{*}(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}\Varid{b}\mathbin{*}(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{2}))\mathbin{+}\Varid{c}\mathbin{*}(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{3})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}\Varid{a}\mathbin{*}(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}\Varid{b}\mathbin{*}(\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{1}))\mathbin{+}\Varid{c}\mathbin{*}(\Varid{i}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{1})){}\<[E]%
\\
\>[B]{}\Varid{h}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{i}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{i}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{i}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}(\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{-}\mathrm{1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fbl}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\p2\comp \for{\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}}\ {\Varid{initial}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{g},\Varid{h}),\Varid{i})\mathrel{=}((\Varid{a}\mathbin{*}\Varid{g}\mathbin{+}\Varid{b}\mathbin{*}\Varid{h}\mathbin{+}\Varid{c}\mathbin{*}\Varid{i},\Varid{g}),\Varid{h}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{initial}\mathrel{=}((\mathrm{1},\mathrm{1}),\mathrm{0}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{g},\Varid{h}),\Varid{i})\mathrel{=}((\Varid{a}\mathbin{*}\Varid{g}\mathbin{+}\Varid{b}\mathbin{*}\Varid{h}\mathbin{+}\Varid{c}\mathbin{*}\Varid{i},\Varid{g}),\Varid{h}){}\<[E]%
\\
...
\subsection*{Problema 2}
O gene vai ser representado por (id -\ensuremath{\mathbin{-}\Varid{id}\times\Varid{gene2})\comp \Varid{out},\Varid{onde}\;\Varid{gene2}\;\Varid{será}\;\Varid{a}\;\Varid{função}\;\Varid{que}\;\Varid{gera}\;\Varid{uma}\;\Varid{lista}\;\Varid{de}\;\Varid{sub}\mathbin{-}\Varid{listas}\;\Varid{dividida}\;\Varid{pela}\;\Varid{sub}\mathbin{-}\Varid{cabeças}\;\Varid{da}\;\Varid{mesma},\Varid{de}\;\Varid{modo}\;\Varid{a}\;\Varid{entregar}\;\Varid{uma}\;[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\;\Varid{para}\;\Varid{executar}\;\map \;\Varid{tax}\;\Varid{de}\;\Varid{forma}\;\Varid{conveniente}\comp \Conid{Antes}\;\Varid{de}\;\Varid{entregar}\;\Varid{a}\;[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\;\Varid{a}\;\map \;\Varid{tax},\Varid{esta}\;\Varid{função}\;\Varid{retira}\;\Varid{ainda}\;\mathrm{4}\;\Varid{espaços}\;\Varid{a}\;\Varid{cada}\;\Varid{elemento}\;\Varid{para}\;\Varid{que}\;\Varid{a}\;\Varid{notação}\;\Varid{seja}\;\Varid{correta}\;\Varid{em}\;\Varid{cada}\;\Varid{iteração}\;\mathbf{do}\;\map \comp \Conid{Gene}\;\Varid{de}}tax\ensuremath{\mathbin{:}\lambda \Varid{begin}\;\{\mskip1.5mu \Varid{code}\mskip1.5mu\}\;\Varid{espacos}\mathbin{::}\Conid{String}\to \Conid{Int}\;\Varid{espacos}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\mathrm{0}\;\Varid{espacos}\;(\Varid{a}\mathbin{:}\Varid{t})} a == ' ' = 1 + espacos(t) 
              \ensuremath{\Varid{otherwise}\mathrel{=}\mathrm{0}\;\Varid{removeEspacoAux}\mathbin{::}\Conid{String}\to \Conid{Int}\to \Conid{String}\;\Varid{removeEspacoAux}\;\Varid{a}\;\mathrm{4}\mathrel{=}\Varid{a}\;\Varid{removeEspacoAux}\;(\Varid{x}\mathbin{:}\Varid{t})\;\Varid{n}} x == ' ' = removeEspacoAux t (n+1)
                        \ensuremath{\Varid{otherwise}\mathrel{=}(\Varid{x}\mathbin{:}\Varid{t})\;\Varid{addLast}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\to \Conid{String}\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\;\Varid{addLast}\;(\Varid{x}\mathbin{:}\Varid{xs})\;\Varid{b}} xs == [] =  [x ++ [b]]
                 \ensuremath{\Varid{otherwise}\mathrel{=}\Varid{addLast}\;\Varid{xs}\;\Varid{b}\mbox{\onelinecomment  caso tenha 4 espaços no inicio vai ser uma sub-cabeça então eu crio uma nova sub-string para essa sub-cabeça, caso não seja subcabeça adiciona à ultima sublista de [[String]] auxGene :: [String] ->[[String]] ->[[String]]  auxGene (b:t) c }} espacos b == 4 = auxGene t (c ++ [[(removeEspacoAux b 1)]])
                \ensuremath{\Varid{otherwise}\mathrel{=}\Varid{auxGene}\;\Varid{t}\;(\Varid{addLast}\;\Varid{c}\;(\Varid{removeEspacoAux}\;\Varid{b}\;\mathrm{1}))\;\Varid{auxGene}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{c}\mathrel{=}\Varid{c}\;\Varid{gene2}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\;\Varid{gene2}\;(\Varid{a}\mathbin{:}\Varid{t})\mathrel{=}\Varid{auxGene}\;\Varid{t}\;[\mskip1.5mu [\mskip1.5mu \mskip1.5mu]\mskip1.5mu]\;\Varid{gene2}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu [\mskip1.5mu \mskip1.5mu]\mskip1.5mu]\;\Varid{gene}\mathrel{=}(\Varid{id}\mathbin{-}}- id >< gene2).out
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}\mathrel{=}\Varid{aux1}\comp \Varid{aux}\comp \Varid{lnks}\comp \Varid{deco}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment aux é uma função que retorna os pares ordenados para serem posteriormente escritos}{}\<[E]%
\\
\>[B]{}\Varid{aux}\mathbin{::}[\mskip1.5mu ((\Conid{Int},\Conid{String}),(\Conid{Int},\Conid{String}))\mskip1.5mu]\to [\mskip1.5mu (\Conid{String},\Conid{String})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{aux}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{aux}\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \p1\;(\Varid{a})\equiv (\p1\;(\Varid{b})\mathbin{+}\mathrm{1})\mathrel{=}((\p2\;(\Varid{a}),\p2\;(\Varid{b}))\mathbin{:}(\Varid{aux}\;\Varid{t})){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}\Varid{aux}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{aux1}\mathbin{::}[\mskip1.5mu (\Conid{String},\Conid{String})\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{aux1}\;\Varid{a}\mathrel{=}\Varid{aux2}\;\Varid{a}\;[\mskip1.5mu [\mskip1.5mu \mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{aux2}\mathbin{::}[\mskip1.5mu (\Conid{String},\Conid{String})\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{aux2}\;[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]\;\anonymous \mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{a},\Varid{b}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{aux2}\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t})\;((\Varid{h}\mathbin{:}\Varid{j})){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{a}\equiv \Varid{last}\;(\Varid{h})\mathrel{=}\Varid{aux2}\;\Varid{t}\;((\Varid{h}\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{a}\mskip1.5mu])\mathbin{:}\Varid{j}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}\Varid{aux2}\;\Varid{t}\;{}\<[35]%
\>[35]{}((\Varid{h}\mathbin{:}\Varid{j})\mathbin{+\!\!\!+}[\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{aux2}\;[\mskip1.5mu \mskip1.5mu]\;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{Square}\mathrel{=}(\Conid{Int},\Conid{Int}){}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Side}\mathrel{=}\Conid{Double}{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Point}\mathrel{=}(\Conid{Double},\Conid{Double}){}\<[E]%
...
&
    \ensuremath{\Conid{Square}\;\Conid{X}\;(\Conid{Rose}\;\Conid{Square})\mathbin{\char94 *}}
        \ar[l]_{\ensuremath{\mathbf{in}}}
\\
    \ensuremath{(\Conid{Square},\Conid{Int})}
        \ar[u]^{\ensuremath{\Varid{squares}}}
        \ar[r]_{\ensuremath{\Varid{gene}}}
&
    \ensuremath{\Conid{Square}\;\Conid{X}\;(\Conid{Square},\Conid{Int})\mathbin{\char94 *}}
        \ar[u]_{\ensuremath{\Varid{id}\;\Conid{X}\;\Varid{squares}\mathbin{\char94 *}}}
}
\end{eqSquaresAna}
...
\xymatrix{
    \ensuremath{\Conid{Rose}\;\Conid{Square}}
       \ar[d]_{\ensuremath{\Varid{rose2List}}}
&
    \ensuremath{\Conid{Square}\;\Conid{X}\;(\Conid{Rose}\;\Conid{Square})\mathbin{\char94 *}}
        \ar[l]_{\ensuremath{\mathbf{in}}}
        \ar[d]^{\ensuremath{\Varid{id}\;\Conid{X}\;\Varid{rose2List}\mathbin{\char94 *}}}
\\
    \ensuremath{(\Conid{Square})\mathbin{\char94 *}}
&
    \ensuremath{\Conid{Square}\;\Conid{X}\;(\Conid{Square}\mathbin{\char94 *})\mathbin{\char94 *}}
...
\xymatrix{
    \ensuremath{(\Conid{Square},\Conid{Int})}
       ...
       \ar[d]_{\ensuremath{\Varid{squares}}}
&
    \ensuremath{\Conid{Square}\;\Conid{X}\;(\Conid{Square},\Conid{Int})\mathbin{\char94 *}}
        \ar[d]^{\ensuremath{\Varid{id}\;\Conid{X}\;\Varid{squares}\mathbin{\char94 *}}}
\\
    \ensuremath{\Conid{Rose}\;\Conid{Square}}
        \ar\text{\ttfamily \char47{}\char94{}\char47{}\char91{}r\char93{}\char94{}\char123{}\char124{}out\char124{}\char125{}~~~~~~~~~\char92{}ar\char91{}d\char93{}\char95{}\char123{}\char124{}rose2List\char124{}\char125{}~\char38{}~~~~~\char124{}Square~X~\char40{}Rose~Square\char41{}\char94{}\char42{}\char124{}~~~~~~~~~\char92{}ar}/^/[l]^{\ensuremath{\mathbf{in}}}
        \ar[d]^{\ensuremath{\Varid{id}\;\Conid{X}\;\Varid{rose2List}\mathbin{\char94 *}}}
\\
    \ensuremath{(\Conid{Square})\mathbin{\char94 *}}
&
...
\begin{eqCarpets}
\xymatrix{
    \ensuremath{(\Conid{Square}\mathbin{\char94 *})\mathbin{\char94 *}}
&
    \ensuremath{\Conid{Square}\mathbin{\char94 *}\Conid{X}\;\Conid{Square}\mathbin{\char94 *}\Conid{X}\;(\Conid{Square}\mathbin{\char94 *})\mathbin{\char94 *}}
        \ar[l]_{\ensuremath{\mathbf{in}}}
\\
    \ensuremath{\N_0}
        \ar[u]^{\ensuremath{\Varid{carpets}}}
        \ar[r]_{\ensuremath{\Varid{gene}}}
&
    \ensuremath{\Conid{Square}\mathbin{\char94 *}\mathbin{+}\Conid{Square}\mathbin{\char94 *}\Conid{X}\;\N_0}
        \ar[u]_{\ensuremath{\Varid{id}\;\Conid{X}\;\Varid{squares}\mathbin{\char94 *}}}
}
\end{eqCarpets}
...
\xymatrix{
    \ensuremath{(\Conid{Square}\mathbin{\char94 *})\mathbin{\char94 *}}
       \ar[d]_{\ensuremath{\Varid{present}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{Square}\mathbin{\char94 *}\Conid{X}\;(\Conid{Square}\mathbin{\char94 *})\mathbin{\char94 *}}
        \ar[l]_{\ensuremath{\mathbf{in}}}
        \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\;\Conid{X}\;\Varid{present}}}
\\
    \ensuremath{\fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{Square}\mathbin{\char94 *}\Conid{X}\;\fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]}
        \ar[l]^{\ensuremath{\Varid{gene}}}
}
\end{eqPresent}
...
\>[B]{}\Varid{sierpinski}\mathbin{::}(\Conid{Square},\Conid{Int})\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{sierpinski}\;(((\Varid{x},\Varid{y}),\Varid{t}),\Varid{p})\mathrel{=}\llbracket\, \Varid{gr2l},\,\Varid{gsq}\,\rrbracket_\textit{\tiny R}\;(((\Varid{x}\mathbin{+}\Varid{t},\Varid{y}\mathbin{+}\Varid{t}),\Varid{t}),\Varid{p}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneCarpets}\mathbin{::}\Conid{Int}\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]+([\mskip1.5mu \Conid{Square}\mskip1.5mu],\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{geneCarpets}\;\mathrm{0}\mathrel{=}i_1\;(\Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\mathrm{0})){}\<[E]%
\\
\>[B]{}\Varid{geneCarpets}\;\Varid{p}\mathrel{=}i_2\;(\Varid{sierpinski}\;(((\mathrm{0},\mathrm{0}),\mathrm{32}),\Varid{p}\mathbin{-}\mathrm{1}),\Varid{p}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{genePresent}\mathbin{::}()+([\mskip1.5mu \Conid{Square}\mskip1.5mu],\fun{IO}\;[\mskip1.5mu ()\mskip1.5mu])\to \fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{genePresent}\;\Varid{g}\mathrel{=}\mathbf{case}\;\Varid{g}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}i_1\;()\to \Varid{return}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}i_2\;(\Varid{s},\Varid{io})\to \mathbf{do}\;\Varid{x}\leftarrow \Varid{io}{}\<[E]%
\\
\>[3]{}\hsindent{19}{}\<[22]%
\>[22]{}\Varid{drawSq}\;\Varid{s}{}\<[E]%
\\
\>[3]{}\hsindent{19}{}\<[22]%
\>[22]{}\Varid{await}{}\<[E]%
\\
\>[3]{}\hsindent{19}{}\<[22]%
\>[22]{}\Varid{return}\;(()\mathbin{:}\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{Square}\mskip1.5mu]\mskip1.5mu]\to \fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{present}\mathrel{=}\llparenthesis\, \Varid{genePresent}\,\rrparenthesis{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{constructSierp}\mathbin{::}\Conid{Int}\to \fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{constructSierp}\mathrel{=}\Varid{present}\comp \Varid{carpets}{}\<[E]%
...
\\
\>[B]{}\Varid{gr2l}\;(\Varid{s},[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \Varid{s}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gr2l}\;(\Varid{s},\Varid{l})\mathrel{=}\Varid{s}\mathbin{:}\Varid{concat}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}\mathbin{::}(\Conid{Square},\Conid{Int})\to (\Conid{Square},[\mskip1.5mu (\Conid{Square},\Conid{Int})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gsq}\;(\Varid{s},\mathrm{0})\mathrel{=}(\Varid{s},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gsq}\;(\Varid{s},\Varid{p})\mathrel{=}(\Varid{s},\map \;(\lambda \Varid{x}\to (\Varid{x},\Varid{p}\mathbin{-}\mathrm{1}))\;(\Varid{carpet}\;\Varid{s})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{carpet}\mathbin{::}\Conid{Square}\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{carpet}\;(\Varid{p},\Varid{l})\mathrel{=}[\mskip1.5mu (\Varid{p}\mathbin{.+}(\mathbin{-}\mathrm{2}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3},{}\<[33]%
\>[33]{}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),(\Varid{p}\mathbin{.+}(\mathbin{-}\mathrm{2}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3},{}\<[61]%
\>[61]{}\mathrm{4}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}(\Varid{p}\mathbin{.+}(\mathbin{-}\mathrm{2}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3},\mathbin{-}\mathrm{2}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),(\Varid{p}\mathbin{.+}({}\<[52]%
\>[52]{}\Varid{l}\mathbin{/}\mathrm{3}{}\<[57]%
\>[57]{},{}\<[57E]%
\>[62]{}\mathrm{4}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}(\Varid{p}\mathbin{.+}({}\<[25]%
\>[25]{}\Varid{l}\mathbin{/}\mathrm{3}{}\<[30]%
\>[30]{},\mathbin{-}\mathrm{2}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),(\Varid{p}\mathbin{.+}(\mathrm{4}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3},{}\<[63]%
\>[63]{}\mathrm{4}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}(\Varid{p}\mathbin{.+}(\mathrm{4}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3},{}\<[35]%
\>[35]{}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3}),(\Varid{p}\mathbin{.+}(\mathrm{4}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3},{}\<[62]%
\>[62]{}\mathbin{-}\mathrm{2}\mathbin{*}\Varid{l}\mathbin{/}\mathrm{3}),\Varid{l}\mathbin{/}\mathrm{3})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rose2List}\mathbin{::}\Conid{Rose}\;\Conid{Square}\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]{}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cgene}\;(i_1\;())\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{cgene}\;(i_2\;(\Varid{h},\Varid{t}))\mathrel{=}\map \;(\Varid{id}\times\Varid{sum})\;(\Varid{collect'}\;\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mathbf{where}\;\Varid{c}\mathrel{=}\Varid{h}\mathbin{:}\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{collect'}\mathbin{::}(\Conid{Eq}\;\Varid{a},\Conid{Num}\;\Varid{b})\Rightarrow [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{b}\mskip1.5mu])\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collect'}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collect'}\;\Varid{l}\mathord{@}((\Varid{x},\Varid{y})\mathbin{:}\Varid{xs})\mathrel{=}(\Varid{x},(\map \;\p2\;(\Varid{filter}\;(\lambda (\Varid{a},\Varid{b})\to \Varid{a}\equiv \Varid{x})\;\Varid{l})))\mathbin{:}\Varid{collect'}\;(\Varid{filter}\;(\lambda (\Varid{a},\Varid{b})\to \Varid{a}\not\equiv \Varid{x})\;\Varid{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{pairup}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{pairup}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}(\map \;(\lambda \Varid{a}\to (\Varid{x},\Varid{a}))\;\Varid{xs})\mathbin{+\!\!\!+}\Varid{pairup}\;\Varid{xs}{}\<[E]%
\\
\>[B]{}\Varid{matchResult}\;\Varid{f}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{w}\equiv \Conid{Nothing}\mathrel{=}[\mskip1.5mu (\Varid{x},\mathrm{1}),(\Varid{y},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{w}\equiv \Conid{Just}\;\Varid{x}{}\<[20]%
\>[20]{}\mathrel{=}[\mskip1.5mu (\Varid{x},\mathrm{3}),(\Varid{y},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{w}\equiv \Conid{Just}\;\Varid{y}{}\<[20]%
\>[20]{}\mathrel{=}[\mskip1.5mu (\Varid{x},\mathrm{0}),(\Varid{y},\mathrm{3})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{w}\mathrel{=}\Varid{f}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{glt}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{glt}\;\Varid{l}\mathrel{=}i_2\;(\Varid{halfList}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\Varid{halfList}\mathbin{::}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{halfList}\;\Varid{l}\mathrel{=}((\Varid{take}\;\Varid{h}\;\Varid{l}),(\Varid{drop}\;\Varid{h}\;\Varid{l})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{h}\mathrel{=}(\length \;\Varid{l})\mathbin{\Varid{`div`}}\mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{Versão probabilística}
\begin{hscode}\SaveRestoreHook
...
\column{30}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pinitKnockoutStage}\;\Varid{d}\mathrel{=}\Varid{return}\mathbin{\$}(\Varid{initKnockoutStage}\;\Varid{d}){}\<[E]%
\\
...
\\
\>[B]{}\Varid{pgroupWinners}\;\Varid{pgsCriteria}\;\Varid{m}\mathrel{=}\Conid{D}\;(\map \;(\lambda (\Varid{a},\Varid{b})\to ((\Varid{best}\;\mathrm{2}\mathbin{\$}\Varid{consolidate}\mathbin{\$}\Varid{concat}\mathbin{\$}\map \;(\lambda (\Varid{c},\Varid{d})\to [\mskip1.5mu \Varid{c},\Varid{d}\mskip1.5mu])\;\Varid{a}),\Varid{b}))\;\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{30}{}\<[30]%
\>[30]{}\mathbf{where}\;\Conid{D}\;\Varid{x}\mathrel{=}\Varid{sequenceA}\mathbin{\$}\map \;(\Varid{pmatchResult}\;\Varid{pgsCriteria})\;\Varid{m}{}\<[E]%
\\
\>[B]{}\Varid{pmatchResult}\;\Varid{f}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \p1\;(\Varid{di}\mathbin{!!}\mathrm{0})\equiv \Conid{Nothing}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Varid{emp},\p2\;(\Varid{di}\mathbin{!!}\mathrm{0})),(\Varid{vx},\p2\;(\Varid{di}\mathbin{!!}\mathrm{1})),(\Varid{vy},\p2\;(\Varid{di}\mathbin{!!}\mathrm{2}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{otherwise}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Varid{vx},\p2\;(\Varid{di}\mathbin{!!}\mathrm{0})),(\Varid{vy},\p2\;(\Varid{di}\mathbin{!!}\mathrm{1}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Conid{D}\;\Varid{di}\mathrel{=}\Varid{f}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{emp}\mathrel{=}((\Varid{x},\mathrm{1}),(\Varid{y},\mathrm{1})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{vx}\mathrel{=}((\Varid{x},\mathrm{3}),(\Varid{y},\mathrm{0})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{vy}\mathrel{=}((\Varid{x},\mathrm{0}),(\Varid{y},\mathrm{3})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{10}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rankingGolos}\mathrel{=}[\mskip1.5mu {}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Argentina\char34},\mathrm{2.14}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Australia\char34},\mathrm{1.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Belgium\char34},\mathrm{1.29}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Brazil\char34},\mathrm{2.01}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Cameroon\char34},\mathrm{1.3}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Canada\char34},\mathrm{0.6}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Costa~Rica\char34},\mathrm{1.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Croatia\char34},\mathrm{1.28}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Denmark\char34},\mathrm{1.11}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Ecuador\char34},\mathrm{1.33}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 England\char34},\mathrm{1.29}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 France\char34},\mathrm{1.7}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Germany\char34},\mathrm{1.47}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Ghana\char34},\mathrm{1.6}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Iran\char34},\mathrm{0.8}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Japan\char34},\mathrm{1.40}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Korea~Republic\char34},\mathrm{1.2}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Mexico\char34},\mathrm{0.66}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Morocco\char34},\mathrm{1.7}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Netherlands\char34},\mathrm{1.63}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Poland\char34},\mathrm{0.64}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Portugal\char34},\mathrm{1.40}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Qatar\char34},\mathrm{0.2}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Saudi~Arabia\char34},\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Senegal\char34},\mathrm{1.15}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Serbia\char34},\mathrm{1.57}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Spain\char34},\mathrm{2.25}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Switzerland\char34},\mathrm{0.62}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Tunisia\char34},\mathrm{0.33}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 USA\char34},\mathrm{0.66}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Uruguay\char34},\mathrm{1.12}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Wales\char34},\mathrm{1.67})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rank'}\;\Varid{x}\mathrel{=}\mathrm{4}\mathbin{**}(\Varid{pap}\;\Varid{rankingsGolos}\;\Varid{x}\mathbin{-}\mathrm{0.2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
